...
1. Open the **repo home** (Code tab) — e.g. `https://github.com/<you>/Coop-AI`
...
```bash
gh repo edit --homepage "https://coop-ai.dev" --description "VS Code code intelligence — Deep-Index repos without cloning, company Slack/Jira in the editor, reviewable edits. Not an autonomous coding agent."
```
