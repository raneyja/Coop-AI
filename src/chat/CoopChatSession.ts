...
export class CoopChatSession {
  ...
  private async enrichChatContextWithIntegrations(
    ...
    return mergeIntegrationChatContext({
      ...
      integrationScopes,
      // Understand / Trace / Blast / Gaps pull connected tools but are time-bounded
      // so a single slow integration can't block synthesis. Soft docs may also skip
      // when core evidence is already Strong.
