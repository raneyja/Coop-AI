...
**Chat file chips:** when a file is attached in the composer, a chip labeled **`owner/repo`** means remote/codehost context; **Local Workspace** means local disk/editor context. See [File context — remote vs local](/docs/file-context).
