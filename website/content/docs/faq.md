...
Yes. After you **Apply** an `/edit`, click **Create pull request**, confirm the branch, title, and notes, and submit. Cancel or Escape creates nothing. See [Create pull request](/docs/create-pull-request).
