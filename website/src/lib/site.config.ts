  ...
  seo: {
    ...
    pages: {
      ...
      privacy: {
        ...
        description: "How CoopAI collects, uses, retains, and protects your data across the website, VS Code extension, and backend services."
      },
      terms: {
        title: "Terms of Service",
        description: "Terms governing use of CoopAI services, including the website, VS Code extension, admin portal, and API."
      }
    }
  },
  links: {
