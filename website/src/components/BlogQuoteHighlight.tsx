...
export function BlogQuoteHighlight({ text, sourceTitle, sourceSlug }: BlogQuoteHighlightProps) {
  return (
    <section className="border-y border-white/5 bg-coop-surface/20 py-16 md:py-20">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="mt-6 text-sm text-coop-muted">
          ...
          <Link href={`/blog/${sourceSlug}`} className="font-medium text-coop-accent hover:text-white">
            Read more →
          </Link>
        </p>
      </div>
