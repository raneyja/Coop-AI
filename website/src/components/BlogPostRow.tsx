    ...
    <article className="group relative grid gap-3 py-6 transition first:pt-0 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:gap-8">
      <div>
        <p className="text-sm text-coop-muted">
          ...
          <span className="capitalize text-gray-700">{formatCategoryLabel(post.category)}</span>
        </p>
        <h2 className="mt-2 text-xl font-semibold tracking-tight text-gray-900 transition-colors group-hover:text-gray-600 md:text-2xl">
